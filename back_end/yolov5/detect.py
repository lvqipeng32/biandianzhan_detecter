        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    YOLOdata = (xyxy2xywh(torch.tensor(xyxy).view(1, 4)) / gn).view(-1).tolist()
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        c = int(cls)  # integer class
                        label = None if hide_labels else (names[c] if hide_conf else f'{names[c]} {conf:.2f}#{distance:.2f}{distance:.2f}')
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / r'E:\xjszt\backend\back_end\tmp\image\test3.mp4', help='file/dir/URL/glob/screen/0(webcam)')
    ...
    parser.add_argument('--project', default=ROOT / r'E:\xjszt\backend\back_end\tmp\draw', help='save results to project/name')
